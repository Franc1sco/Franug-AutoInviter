...
#define LOGIN_FILE_NAME "franug-autoinviter/franug_login"
...
OnLoginPluginStart()
{
	...
	RegAdminCmd("sm_autoinviter_last_error", cmdLastError, ADMFLAG_ROOT, "Gets the last login error.");
	RegAdminCmd("sm_autoinviter_send_code", cmdSendCode, ADMFLAG_ROOT, "Attempts to send the auth code to mail.");
	RegAdminCmd("sm_autoinviter_input_code", cmdInputCode, ADMFLAG_ROOT, "Sets the code needed to login and then attempts to login.");
